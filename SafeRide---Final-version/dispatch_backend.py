...
Integrated by: Jacob Brown, Zhibin Zhang, Conor Tracey
Serves as engine of the App
...
def rider():
    ...
    goBackMsg = 'Please go back and resubmit.'
    my_map = ''
    if request.method == 'POST':
        try:
            ...
            if nm=='' or tm=='' or phn=='' or uoid=='' or tddr=='' or fddr=='' or rdrs=='':
                bad = True
                msg = "Error in submitting request - is one of the fields empty?"
            ...
            if not bad:
                ...
                msg = "Information Submitted. Our staff will contact you soon."
                goBackMsg = ''
                ...
                return render_template("map.html", msg=msg, my_map=my_map, goBackMsg=goBackMsg)
                con.close()
